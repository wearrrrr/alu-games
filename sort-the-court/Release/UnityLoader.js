    ...
    return function e(t, n, o) {
        ...
        2: [function(e, t, n) {
            ...
            n.string2buf = function(e) {
                var t, n, o, a, r, s = e.length, l = 0;
                for (a = 0; s > a; a++)
                    n = e.charCodeAt(a),
                    55296 === (64512 & n) && s > a + 1 && (o = e.charCodeAt(a + 1),
                ...
                a = 0; l > r; a++)
                    ...
                    56320 === (64512 & o) && (n = 65536 + (n - 55296 << 10) + (o - 56320),
                    a++)),
                    128 > n ? t[r++] = n : 2048 > n ? (t[r++] = 192 | n >>> 6,
                    t[r++] = 128 | 63 & n) : 65536 > n ? (t[r++] = 224 | n >>> 12,
                    t[r++] = 128 | n >>> 6 & 63,
            ...
            n.buf2string = function(e, t) {
                var n, i, a, r, s = t || e.length, d = new Array(2 * s);
                for (i = 0,
                n = 0; s > n; )
                    if (a = e[n++],
                    128 > a)
                    ...
                    r > 4)
                        ...
                        for (a &= 2 === r ? 31 : 3 === r ? 15 : 7; r > 1 && s > n; )
                            a = a << 6 | 63 & e[n++],
                            r--;
                        r > 1 ? d[i++] = 65533 : 65536 > a ? d[i++] = a : (a -= 65536,
                        d[i++] = 55296 | a >> 10 & 1023,
                        d[i++] = 56320 | 1023 & a)
                    }
                return o(d, i)
        ...
        8: [function(e, t, n) {
            ...
            function s(e, t) {
                ...
                t = -t) : (n = (t >> 4) + 1,
                48 > t && (t &= 15)),
                t && (8 > t || t > 15) ? L : (null !== o.window && o.wbits !== t && (o.window = null),
                o.wrap = n,
                o.wbits = t,
                r(e))) : L
            }
            ...
            function c(e, t, n, o) {
                ...
                o >= a.wsize ? (w.arraySet(a.window, t, n - a.wsize, a.wsize, 0),
                a.wnext = 0,
                a.whave = a.wsize) : (i = a.wsize - a.wnext,
                i > o && (i = o),
                w.arraySet(a.window, t, n - o, i, a.wnext),
                o -= i,
                o ? (w.arraySet(a.window, t, n - o, o, 0),
                a.wnext = o,
            ...
            function f(e, t) {
                var n, i, a, r, s, l, d, f, h, m, p, b, me, pe, be, we, ge, ve, ke, ye, _e, xe, Se, Me, Ce = 0, Ee = new w.Buf8(4), Re = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                ...
                e: for (; ; )
                    ...
                    case N:
                        ...
                        b > l && (b = l),
                        b && (n.head && (_e = n.head.extra_len - n.length,
                        n.head.extra || (n.head.extra = new Array(n.head.extra_len)),
                        w.arraySet(n.head.extra, i, r, b, _e)),
                    ...
                    case q:
                        if (2048 & n.flags) {
                            ...
                            do
                                _e = i[r + b++],
                                n.head && _e && n.length < 65536 && (n.head.name += String.fromCharCode(_e));
                            while (_e && l > b);
                            if (512 & n.flags && (n.check = v(n.check, i, b, r)),
                            l -= b,
                            r += b,
                            _e)
                                break e
                    ...
                    case G:
                        if (4096 & n.flags) {
                            ...
                            do
                                _e = i[r + b++],
                                n.head && _e && n.length < 65536 && (n.head.comment += String.fromCharCode(_e));
                            while (_e && l > b);
                            if (512 & n.flags && (n.check = v(n.check, i, b, r)),
                            l -= b,
                            r += b,
                    ...
                    case $:
                        ...
                        xe = y(_, n.lens, 0, 19, n.lencode, 0, n.work, Se),
                        n.lenbits = Se.bits,
                        xe) {
                    ...
                    case ee:
                        for (; n.have < n.nlen + n.ndist; ) {
                            for (; Ce = n.lencode[f & (1 << n.lenbits) - 1],
                            be = Ce >>> 24,
                            we = Ce >>> 16 & 255,
                            ge = 65535 & Ce,
                            !(h >= be); ) {
                        ...
                        xe = y(x, n.lens, 0, n.nlen, n.lencode, 0, n.work, Se),
                        n.lenbits = Se.bits,
                        xe) {
                        ...
                        xe = y(S, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, Se),
                        n.distbits = Se.bits,
                        xe) {
                    ...
                    case ne:
                        ...
                        for (n.back = 0; Ce = n.lencode[f & (1 << n.lenbits) - 1],
                        be = Ce >>> 24,
                        we = Ce >>> 16 & 255,
                        ge = 65535 & Ce,
                        !(h >= be); ) {
                        ...
                        if (we && 0 === (240 & we)) {
                            for (ve = be,
                            ke = we,
                            ye = ge; Ce = n.lencode[ye + ((f & (1 << ve + ke) - 1) >> ve)],
                            be = Ce >>> 24,
                            we = Ce >>> 16 & 255,
                            ge = 65535 & Ce,
                            !(h >= ve + be); ) {
                    ...
                    case oe:
                        ...
                        n.mode = ie;
                    case ie:
                        for (; Ce = n.distcode[f & (1 << n.distbits) - 1],
                        be = Ce >>> 24,
                        we = Ce >>> 16 & 255,
                        ge = 65535 & Ce,
                        !(h >= be); ) {
                        ...
                        if (0 === (240 & we)) {
                            for (ve = be,
                            ke = we,
                            ye = ge; Ce = n.distcode[ye + ((f & (1 << ve + ke) - 1) >> ve)],
                            be = Ce >>> 24,
                            we = Ce >>> 16 & 255,
                            ge = 65535 & Ce,
                            !(h >= ve + be); ) {
                    ...
                    case le:
                        if (n.wrap) {
                            ...
                            e.total_out += p,
                            n.total += p,
                            p && (e.adler = n.check = n.flags ? v(n.check, a, p, s - p) : g(n.check, a, p, s - p)),
                            p = d,
                ...
                n.hold = f,
                n.bits = h,
                (n.wsize || p !== e.avail_out && n.mode < ce && (n.mode < le || t !== M)) && c(e, e.output, e.next_out, p - e.avail_out) ? (n.mode = fe,
                z) : (m -= e.avail_in,
                p -= e.avail_out,
                e.total_in += m,
                e.total_out += p,
                ...
                e.data_type = n.bits + (n.last ? 64 : 0) + (n.mode === J ? 128 : 0) + (n.mode === te || n.mode === X ? 256 : 0),
                (0 === m && 0 === p || t === M) && xe === R && (xe = B),
                xe)
            }
            function h(e) {
                if (!e || !e.state)
        ...
        9: [function(e, t, n) {
            ...
            t.exports = function(e, t, n, m, p, b, w, g) {
                var v, k, y, _, x, S, M, C, E, R = g.bits, F = 0, D = 0, L = 0, A = 0, z = 0, B = 0, I = 0, U = 0, O = 0, Z = 0, P = null, T = 0, N = new o.Buf16(i + 1), q = new o.Buf16(i + 1), G = null, j = 0;
                for (F = 0; i >= F; F++)
                    N[F] = 0;
                for (D = 0; m > D; D++)
                    N[t[n + D]]++;
                ...
                return 0 !== Z && (p[x + Z] = F - I << 24 | 64 << 16 | 0),
                g.bits = z,
                0
            }
        }
        ...
        "/lib/inflate.js": [function(e, t, n) {
            ...
            h.prototype.push = function(e, t) {
                var n, o, i, d, u, c = this.strm, h = this.options.chunkSize;
                if (this.ended)
                    return !1;
                ...
                do {
                    if (0 === c.avail_out && (c.output = new r.Buf8(h),
                    c.next_out = 0,
                    c.avail_out = h),
                    n = a.inflate(c, l.Z_NO_FLUSH),
                    n !== l.Z_STREAM_END && n !== l.Z_OK)
                        return this.onEnd(n),
                        this.ended = !0,
                        !1;
                    c.next_out && (0 === c.avail_out || n === l.Z_STREAM_END || 0 === c.avail_in && (o === l.Z_FINISH || o === l.Z_SYNC_FLUSH)) && ("string" === this.options.to ? (i = s.utf8border(c.output, c.next_out),
                    d = c.next_out - i,
                    u = s.buf2string(c.output, i),
                    c.next_out = d,
                    c.avail_out = h - d,
                    d && r.arraySet(c.output, c.output, i, d, 0),
                    this.onData(u)) : this.onData(r.shrinkBuf(c.output, c.next_out)))
                } while (c.avail_in > 0 && n !== l.Z_STREAM_END);
                return n === l.Z_STREAM_END && (o = l.Z_FINISH),
                o === l.Z_FINISH ? (n = a.inflateEnd(this.strm),
                this.onEnd(n),
                this.ended = !0,
                n === l.Z_OK) : o === l.Z_SYNC_FLUSH ? (this.onEnd(l.Z_OK),
                c.avail_out = 0,
                !0) : !0
            }
            ,
...
function() {
    var e = function(e) {
        ...
        function n() {
            ...
            new t(0,9431348,0,0).open("GET", "/data.unity3d"),
            new t(9431348,9431763,0,0).open("GET", "/methods_pointedto_by_uievents.xml"),
            new t(9431763,12039219,0,0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"),
            new t(12039219,13535911,0,0).open("GET", "/Resources/unity_default_resources"),
            new t(13535911,13563537,0,0).open("GET", "/Managed/mono/2.0/machine.config"),
        ...
        Module.calledRun ? n() : (Module.preRun || (Module.preRun = []),
        Module.preRun.push(n))
    };
    e()
}();
